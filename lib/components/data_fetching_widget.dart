            ...
            return FutureBuilder(
              builder: (context, snapshot) {
                if (snapshot.hasError) {
                  ...
                  final productsJson = (snapshot.data![0]
                          as QuerySnapshot<Map<String, dynamic>>?)!
                      .docs
                      .map((e) => e.data())
                      .toList();
                  final rewardsJson = (snapshot.data![1]
                          as QuerySnapshot<Map<String, dynamic>>?)!
                      .docs
                      .map((e) => e.data())
                      .toList();
                  final userJson = (snapshot.data![2]
                          as DocumentSnapshot<Map<String, dynamic>>?)!
                      .data()!;
                  final runtimePayloadJson = (snapshot.data![3]
                          as DocumentSnapshot<Map<String, dynamic>>?)!
                      .data()!;
                  ...
                  final runtimePayload =
                      RuntimePayload.fromJson(runtimePayloadJson);
                  ...
                  return RepositoryProvider.value(
                      ...
                      child: MaterialApp(
                          ...
                          home: BlocProvider(
                            create: (context) =>
                                NavigationBloc(applicationRepository),
